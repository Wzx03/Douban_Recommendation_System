...
print("正在加载数据...")
movies_df = pd.read_csv('cleaned_data/cleaned_movies.csv', encoding='utf-8')
ratings_df = pd.read_csv('cleaned_data/cleaned_ratings.csv', encoding='utf-8')
original_users_df = pd.read_csv('raw_data/user.csv', encoding='utf-8')
